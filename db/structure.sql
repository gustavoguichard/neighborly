...
CREATE FUNCTION expires_at(projects) RETURNS timestamp with time zone
    LANGUAGE sql
    AS $_$
                   SELECT ((($1.sale_date AT TIME ZONE 'US/Central' + ($1.online_days || ' days')::interval)::date::text || ' 23:59:59')::timestamp AT TIME ZONE 'America/Chicago')
                  $_$;
...
CREATE TABLE rewards (
    ...
    updated_at timestamp without time zone,
    row_order integer,
    happens_at date DEFAULT '2014-09-17'::date NOT NULL,
