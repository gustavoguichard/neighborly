class RemoveTaxExemptYieldFromProjects < ActiveRecord::Migration
  def up
    drop_dependent_objects

    remove_column :projects, :tax_exempt_yield, null: false, default: 0
  ...
  def down
    ...
    add_column :projects, :tax_exempt_yield, null: false, default: 0
