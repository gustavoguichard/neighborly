class RemoveConfigurations < ActiveRecord::Migration
  def up
    ...
    # Removes platform_fee field
    # Removes net_amount field
    ...
    # Removes platform_fee field
    # Removes repass_value field
    # Removes platform_fee_percentage field
    # Removes platform_base_url field
    # Removes contribution_report field
    execute <<-SQL
